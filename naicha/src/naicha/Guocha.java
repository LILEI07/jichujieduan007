 ...
 */
public class Guocha extends JFrame implements MouseListener {
    ...
    JRadioButton zhishi = new JRadioButton("芝士");
    JRadioButton naigai = new JRadioButton("奶盖");
    JRadioButton xuegao = new JRadioButton("雪糕");
    ...
    int m = -1;//m代表不同的商品
    int number = -1;
    public Guocha(int m, int number) {
        this.m = m;
        this.number = number;
    ...
    private void initView() {
        ...
        zhishi.setOpaque(false);
        naigai.setOpaque(false);
        xuegao.setOpaque(false);
        ...
        //珍珠
        zhishi.setFont(new Font("宋体", 6, 15));
        zhishi.setBounds(50, 275, 70, 40);
        //椰果
        naigai.setFont(new Font("宋体", 6, 15));
        naigai.setBounds(140, 275, 70, 40);
        //布丁
        xuegao.setFont(new Font("宋体", 6, 15));
        xuegao.setBounds(230, 275, 70, 40);
        //不加配料
        ...
        this.getContentPane().add(zhishi);
        this.getContentPane().add(naigai);
        this.getContentPane().add(xuegao);
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getSource() == queren) {
            ...
            if (zhishi.isSelected()) {
                peiliao = 1;
            }
            if (naigai.isSelected()) {
                peiliao = 2;
            }
            if (xuegao.isSelected()) {
                peiliao = 3;
            }
